...
<head>
	<title>
		<?php foreach($movietype_trailer as $movietype_trailers) 
								{ echo $movietype_trailers->Movie_Type_Name. " Movie";}?>
	</title>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span3">
			 ...
			 <div class="row-fluid">
			 					<div class="row-fluid" >
									<div class="well well-small">
											<?php	
												foreach($movietype_trailer as $movietype_trailers)
												 {
																																		
													echo '<div class="span4">'.$movietype_trailers->Movie_Type_Name.'</div>';
													
												}?>
										<div class="span1 offset7">
											<?php if($movietype_trailer_cnt > 3)
												{
													echo'<p><a href="'.base_url().'index.php/movie/movietype_see_all/'.$this->uri->segment(3).'">See all</a></p>';
												}
											?>
										</div>
									</div>
			...
			<div class="row-fluid">
				<ul class="thumbnails">
				<?php foreach($movietype as $Movie_movies)
				{
					...
					<div class="rating">
						...
						<span style="float:left;padding-left:10px;"><i class="icon-comment">'.$Movie_movies->cnt.'</i></span>
					</div>
				</li>';
				}?>
			</ul>
