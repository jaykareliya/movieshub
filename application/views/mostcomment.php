...
<head>
	<title>Most Commented Movie</title>
				  ...
				  <div class="row-fluid">
			 					<div class="row-fluid" >
									<div class="well well-small">
										<div class="span4">MOST COMMENTED</div>
										<div class="span1 offset7" >
											<?php if($mostcomment_count > 3)
												echo'<p class="text-right"><a href="'.base_url().'index.php/movie/most_comment_see_all">See all</a></p>';
											?>
										</div>
									</div>
								</div>
					...
					<div class="row-fluid">
						<ul class="thumbnails">
								<?php foreach($most_comment as $most_comments)
								{
	
									$rate= $most_comments->Movie_Rating * 12;
									echo '<li class="span4">
								
										<a href="'.base_url().'index.php/movie/movie_name/'.$most_comments->Movie_Id.'" class="thumbnail"><img src="'.base_url().'images/movie/'.$most_comments->Movie_Image.'" alt="" /></a>
									...
									<div class="rating" >
										...
										<span ><i class="icon-comment">'.$most_comments->cnt.'</i></span>
									</div>
								</li>';
							}?>
							</ul>
