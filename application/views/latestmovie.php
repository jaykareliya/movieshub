			   			...
			   			<div class="row-fluid">
			 				<div class="row-fluid" >
								<div class="well well-small">
										<div class="span4">LATEST MOVIES</div>
										<div class="span1 offset7">
												<?php if($latest_movie_count > 3)
													echo'<a href="'.base_url().'index.php/movie/latest_movie_see_all">See all</a>';
												?>
										</div>
								</div>
							</div>
							...
							<div class="row-fluid">
								<ul class="thumbnails">
									<?php foreach($latest_movie as $latest_movies)
									{
				
									$rate= $latest_movies->Movie_Rating * 12;
									echo '<li class="span4">
										<a href="'.base_url().'index.php/movie/movie_name/'.$latest_movies->movie_id.'" class="thumbnail"><img src="'.base_url().'images/movie/'.$latest_movies->movie_image.'" alt="" /></a>
									...
									<div class="rating">
										...
										<span ><i class="icon-comment">'.$latest_movies->cnt.'</i></span>
									</div>
									</li>';
										}?>
								</ul>
